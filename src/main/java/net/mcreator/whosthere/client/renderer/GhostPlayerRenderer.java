...
public class GhostPlayerRenderer extends HumanoidMobRenderer<GhostPlayerEntity, HumanoidModel<GhostPlayerEntity>> {
	...
	public ResourceLocation getTextureLocation(GhostPlayerEntity entity) {
		return new ResourceLocation("whos_there:textures/entities/invisible_entity.png");
	}
}
