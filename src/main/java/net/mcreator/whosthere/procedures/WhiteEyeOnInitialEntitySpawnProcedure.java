...
public class WhiteEyeOnInitialEntitySpawnProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity) {
		if (entity == null)
			return;
		if (entity instanceof WhiteEyeEntity && Math.random() < (double) GhostPlayersConfigConfiguration.WHITEEYESDESPAWNCHANCE.get()) {
