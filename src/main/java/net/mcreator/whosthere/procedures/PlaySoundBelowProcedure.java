...
public class PlaySoundBelowProcedure {
			...
			if (entity.getPersistentData().getDouble("breakSoundCount") == 0) {
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						...
						}.compareDistOf(x, y, z)).findFirst().orElse(null)).getZ()), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.deepslate.hit")), SoundSource.BLOCKS,
				...
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						...
						}.compareDistOf(x, y, z)).findFirst().orElse(null)).getZ()), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.deepslate.break")), SoundSource.BLOCKS,
